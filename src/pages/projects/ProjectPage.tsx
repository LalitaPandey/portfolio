...
import { professionalProject} from "pages/Data";
...
const ProjectPage = () => {
  ...
  const handleSourceButtonClick = (project: any) => {
    if (project.type === "professional") {
      if (project.id === 1) {
        window.open("https://github.com/LalitaPandey/portfolio");
      }
      if (project.id === 2) {
        window.open("https://github.com/LalitaPandey/portfolio");
      }
  ...
  //     }
  //     if (pproject.id === 3) {
  //       window.open("https://vinayan-ten.vercel.app/");
  //     }
  //   }
  // };
  return (
